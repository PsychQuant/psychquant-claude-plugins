...
**包含 Skills**:
- `claude-code-guide` — Claude Code CLI / API / SDK 文檔
...
| Plugin | New home |
|--------|----------|
| `perspective-writer` | Standalone marketplace [PsychQuant/perspective-writer](https://github.com/PsychQuant/perspective-writer)（2026-07-18 抽出，#116）。安裝：`claude plugin marketplace add PsychQuant/perspective-writer` + `claude plugin install perspective-writer@perspective-writer` |
